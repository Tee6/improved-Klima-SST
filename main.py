...
def getSpeechToKlima(speechFile):
    ...
    dictionary["Command"] = CommandType
    dictionary["Feature"] = Features[0]
    dictionary["data"][0]["value"] = Intensity
    dictionary["data"][0]["Time"] = relative_unixTime
    dictionary["data"][1]["value"] = Intensity
    dictionary["data"][2]["Place"] = Place
